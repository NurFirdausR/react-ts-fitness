    ...
    <section id="contactus" className="mx-auto w-5/6 pt-24 pb-32">
      <motion.div onViewportEnter={() => setSelectedPage(SelectedPage.ContactUs)}>
          ...
          variants={{
              ...
              <p className="my-5">
              At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti q
               </p>
          </motion.div>
          {/* FORM AND IMAGE */}
          <div className="mt-10 justify-between gap-8 md:flex">
            ...
            variants={{
              ...
              target="_blank" 
              onSubmit={onSubmit}
              action="https://formsubmit.co/nfrdsrxx@gmail.com"
              method="POST" 
              >
...
<textarea className={inputStyles} rows={4} cols={50} placeholder="MESSAGE" {...register("message", {
          ...
          <button type="submit" className="mt-5 rounded-lg bg-secondary-500 px-20 py-30 transition duration-500 hover:text-white">
                  SUBMIT
          </button>
              </form>
